...
export default function ComponentDataTable({
  ...
  const toggleFullscreen = () => {
    const elem = document.getElementById("component-datatable-container");
  ...
  const exportExcel = () => {
    ...
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "components.xlsx");
  };
  ...
  return (
    <Paper
      id="component-datatable-container"
