...
// ─── RequestableItem DataTable ───────────────────────────────────────────────────────
export default function RequestableItemDataTable({
  columns,
  data,
  onRefresh,
  createPath = "/assets/action/create",
  createLabel = "+ Create Requestable Item",
}) {
  ...
  const toggleFullscreen = () => {
    const elem = document.getElementById("requestable-datatable-container");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Requestable Items");
    const excelBuffer = XLSX.write(workbook, { bookType: "xlsx", type: "array" });
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "requestable-items.xlsx");
  };
  ...
  const exportPDF = () => {
    ...
    doc.save("requestable-items.pdf");
  };
  ...
  const CustomToolbar = () => (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        ...
        {/* Create button intentionally hidden for this table */}
  ...
  return (
    <Paper
      id="requestable-datatable-container"
