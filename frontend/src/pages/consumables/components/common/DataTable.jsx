...
// ─── Consumable DataTable ───────────────────────────────────────────────────────
export default function ConsumableDataTable({
  columns,
  data,
  onRefresh,
  ...
  const toggleFullscreen = () => {
    const elem = document.getElementById("consumable-datatable-container");
  ...
  const exportExcel = () => {
    ...
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "consumables.xlsx");
  };
  ...
  return (
    <Paper
      id="consumable-datatable-container"
