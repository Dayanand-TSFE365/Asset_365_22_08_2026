  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        ...
        <PermissionButton permission="create_people" onClick={() => ctx.navigate(ctx.createPath)}>
        ...
        {(() => {
          const canExport = hasPermission("export_people");
          return (
            <Select
              size="small"
              value="Export"
              ...
              onChange={(e) => {
                ...
                if (value === "Excel" || value === "CSV") ctx.exportExcel();
                if (value === "PDF") ctx.exportPDF();
...
export default function PeopleDataTable({
  ...
  const exportExcel = useCallback(() => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Peoples");
    const excelBuffer = XLSX.write(workbook, { bookType: "xlsx", type: "array" });
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "peoples.xlsx");
  }, [data, columns]);
