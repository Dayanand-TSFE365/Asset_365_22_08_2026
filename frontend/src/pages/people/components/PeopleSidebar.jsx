...
export default function PeopleSidebar({ visible, isOpen, setShow, anchorTop }) {
  ...
  const PADDING       = 16;
  const contentHeight = HEADER_HEIGHT + peopleMenu.length * ITEM_HEIGHT + PADDING;
