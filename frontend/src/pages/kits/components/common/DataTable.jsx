...
// ─── Kit DataTable ───────────────────────────────────────────────────────
export default function KitDataTable({
  columns,
  data,
  onRefresh,
  ...
  const toggleFullscreen = () => {
    const elem = document.getElementById("kit-datatable-container");
  ...
  const exportExcel = () => {
    ...
    saveAs(new Blob([excelBuffer], { type: "application/octet-stream" }), "kits.xlsx");
  };
